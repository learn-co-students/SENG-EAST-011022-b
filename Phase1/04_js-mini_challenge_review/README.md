...
**YOUR NOTES**
```
Make sure JS loads after HTML doc is loaded using one of these 3 aproaches
- using defer in the script tag
- moving the script tag down to the bottom of our html
- using the domContentLoaded event listener
