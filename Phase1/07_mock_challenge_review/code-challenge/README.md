...
- where to start
- pulling all the text fields when using a form (on submit)
- while we review using a git flow
- .map .forEach [outputs and scote]* 
- getting the image to show from the form
- Review a liker button functionality
